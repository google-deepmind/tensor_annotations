...
# This is a manually-edited version of the API stubs generated by a
# Google-internal TensorFlow stubs generator.
...
class CriticalSection(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  name: Any
  def __init__(self, name=..., shared_name=..., critical_section_def=..., import_scope=...) -> Any: ...
...
class DeviceSpec(object):
  ...
  replica: Any
  task: Any
  def __init__(self, job=..., replica=..., task=..., device_type=..., device_index=...) -> Any: ...
  @classmethod def from_string(cls, spec) -> Any: ...
...
class GradientTape(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  def __init__(self, persistent=..., watch_accessed_variables=...) -> Any: ...
...
class IndexedSlices(object):
  ...
  shape: Any
  values: Any
  def __init__(self, values, indices, dense_shape=...) -> Any: ...
  def consumers(self) -> Any: ...

class IndexedSlicesSpec(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  value_type: Any
  def __init__(self, shape=..., dtype=..., indices_dtype=..., dense_shape_dtype=..., indices_shape=...) -> Any: ...
...
class Module(object):
  ...
  @classmethod def with_name_scope(cls, method) -> Any: ...
...
class Operation(object):
  ...
  traceback: Any
  type: Any
  def __init__(self, node_def, g, inputs=..., output_types=..., control_inputs=..., input_types=..., original_op=..., op_def=...) -> Any: ...
...
class OptionalSpec(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  value_type: Any
  def __init__(self, element_spec) -> Any: ...
...
class RaggedTensor(object):
  ...
  values: Any
  def __init__(self, values, row_partition, internal=...) -> Any: ...
  def bounding_shape(self, axis=..., name=..., out_type=...) -> Any: ...
  def consumers(self) -> Any: ...
  @classmethod def from_nested_row_lengths(cls, flat_values, nested_row_lengths, name=..., validate=...) -> Any: ...
  @classmethod def from_nested_row_splits(cls, flat_values, nested_row_splits, name=..., validate=...) -> Any: ...
  @classmethod def from_nested_value_rowids(cls, flat_values, nested_value_rowids, nested_nrows=..., name=..., validate=...) -> Any: ...
  @classmethod def from_row_lengths(cls, values, row_lengths, name=..., validate=...) -> Any: ...
  @classmethod def from_row_limits(cls, values, row_limits, name=..., validate=...) -> Any: ...
  @classmethod def from_row_splits(cls, values, row_splits, name=..., validate=...) -> Any: ...
  @classmethod def from_row_starts(cls, values, row_starts, name=..., validate=...) -> Any: ...
  @classmethod def from_sparse(cls, st_input, name=..., row_splits_dtype=...) -> Any: ...
  @classmethod def from_tensor(cls, tensor, lengths=..., padding=..., ragged_rank=..., name=..., row_splits_dtype=...) -> Any: ...
  @classmethod def from_uniform_row_length(cls, values, uniform_row_length, nrows=..., validate=..., name=...) -> Any: ...
  @classmethod def from_value_rowids(cls, values, value_rowids, nrows=..., name=..., validate=...) -> Any: ...
...
class RaggedTensorSpec(object):
  ...
  shape: Any
  value_type: Any
  def __init__(self, shape=..., dtype=..., ragged_rank=..., row_splits_dtype=...) -> Any: ...
  @classmethod def from_value(cls, value) -> Any: ...
  def is_compatible_with(self, spec_or_value) -> Any: ...
  def most_specific_compatible_type(self, other) -> Any: ...

class RegisterGradient(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  def __init__(self, op_type) -> Any: ...
...
class SparseTensor(object):
  ...
  shape: Any
  values: Any
  def __init__(self, indices, values, dense_shape) -> Any: ...
  def consumers(self) -> Any: ...
  def eval(self, feed_dict=..., session=...) -> Any: ...
  @classmethod def from_value(cls, sparse_tensor_value) -> Any: ...
...
class Tensor(object):
  ...
  shape: Any
  value_index: Any
  def __init__(self, op, value_index, dtype) -> Any: ...
  def consumers(self) -> Any: ...
  def eval(self, feed_dict=..., session=...) -> Any: ...
...
class TensorArray(object):
  ...
  flow: Any
  handle: Any
  def __init__(self, dtype, size=..., dynamic_size=..., clear_after_read=..., tensor_array_name=..., handle=..., flow=..., infer_shape=..., element_shape=..., colocate_with_first_write_call=..., name=...) -> Any: ...
...
class TensorArraySpec(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  value_type: Any
  def __init__(self, element_shape=..., dtype=..., dynamic_size=..., infer_shape=...) -> Any: ...
  def from_value(value) -> Any: ...
  def is_compatible_with(self, other) -> Any: ...
  def most_specific_compatible_type(self, other) -> Any: ...
...
class TensorSpec(object):
  ...
  shape: Any
  value_type: Any
  def __init__(self, shape, dtype=..., name=...) -> Any: ...
  @classmethod def from_spec(cls, spec, name=...) -> Any: ...
  @classmethod def from_tensor(cls, tensor, name=...) -> Any: ...
...
class Variable(object):
  ...
  synchronization: Any
  trainable: Any
  def __init__(self, initial_value=..., trainable=..., validate_shape=..., caching_device=..., name=..., variable_def=..., dtype=..., import_scope=..., constraint=..., synchronization=..., aggregation=..., shape=...) -> Any: ...
...
class constant_initializer(object):
  ...
  @classmethod def from_config(cls, config) -> Any: ...
...
class random_normal_initializer(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  def __init__(self, mean=..., stddev=..., seed=...) -> Any: ...
  @classmethod def from_config(cls, config) -> Any: ...
  def get_config(self) -> Any: ...

class random_uniform_initializer(object):
  _HAS_DYNAMIC_ATTRIBUTES = True
  def __init__(self, minval=..., maxval=..., seed=...) -> Any: ...
  @classmethod def from_config(cls, config) -> Any: ...
  def get_config(self) -> Any: ...
...
def function(func=..., input_signature=..., autograph=..., experimental_implements=..., experimental_autograph_options=..., experimental_relax_shapes=..., experimental_compile=...) -> Any: ...
...
def no_op(name=...) -> Any: ...
def nondifferentiable_batch_function(num_batch_threads, max_batch_size, batch_timeout_micros, allowed_batch_sizes=..., max_enqueued_batches=..., autograph=...) -> Any: ...
...
@overload
def ones(shape, dtype=..., name=...) -> Tensor: ...
...
@overload
def ones_like(input: Tensor2[A2, A1], dtype=..., name=...) -> Tensor2[A2, A1]: ...

@overload
def ones_like(input: Tensor3[A3, A2, A1], dtype=..., name=...) -> Tensor3[A3, A2, A1]: ...

@overload
def ones_like(input: Tensor4[A4, A3, A2, A1], dtype=..., name=...) -> Tensor4[A4, A3, A2, A1]: ...
...
@overload
def reduce_all(input_tensor: Tensor2[A2, A1],
               axis: L1, name=...) -> Tensor1[A2]: ...

@overload
def reduce_all(input_tensor: Tensor3[A3, A2, A1],
               axis: L0, name=...) -> Tensor2[A2, A1]: ...

@overload
def reduce_all(input_tensor: Tensor3[A3, A2, A1],
               axis: L1, name=...) -> Tensor2[A3, A1]: ...

@overload
def reduce_all(input_tensor: Tensor3[A3, A2, A1],
               axis: L2, name=...) -> Tensor2[A3, A2]: ...

@overload
def reduce_all(input_tensor: Tensor4[A4, A3, A2, A1],
               axis: L0, name=...) -> Tensor3[A3, A2, A1]: ...

@overload
def reduce_all(input_tensor: Tensor4[A4, A3, A2, A1],
               axis: L1, name=...) -> Tensor3[A4, A2, A1]: ...

@overload
def reduce_all(input_tensor: Tensor4[A4, A3, A2, A1],
               axis: L2, name=...) -> Tensor3[A4, A3, A1]: ...

@overload
def reduce_all(input_tensor: Tensor4[A4, A3, A2, A1],
               axis: L3, name=...) -> Tensor3[A4, A3, A2]: ...
...
@overload
def transpose(a: Tensor2[A2, A1], name=...) -> Tensor2[A1, A2]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], name=...) -> Tensor3[A1, A2, A3]: ...

@overload
def transpose(a: Tensor4[A4, A3, A2, A1], name=...) -> Tensor4[A1, A2, A3, A4]: ...

@overload
def transpose(a: Tensor2[A2, A1], perm: Tuple[L0, L1],
              name=...) -> Tensor2[A2, A1]: ...

@overload
def transpose(a: Tensor2[A2, A1], perm: Tuple[L1, L0],
              name=...) -> Tensor2[A1, A2]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L0, L1, L2],
              name=...) -> Tensor3[A3, A2, A1]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L0, L2, L1],
              name=...) -> Tensor3[A3, A1, A2]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L1, L0, L2],
              name=...) -> Tensor3[A2, A3, A1]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L1, L2, L0],
              name=...) -> Tensor3[A2, A1, A3]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L2, L0, L1],
              name=...) -> Tensor3[A1, A3, A2]: ...

@overload
def transpose(a: Tensor3[A3, A2, A1], perm: Tuple[L2, L1, L0],
...
@overload
def zeros_like(input: Tensor2[A2, A1], dtype=..., name=...) -> Tensor2[A2, A1]: ...

@overload
def zeros_like(input: Tensor3[A3, A2, A1], dtype=..., name=...) -> Tensor3[A3, A2, A1]: ...

@overload
def zeros_like(input: Tensor4[A4, A3, A2, A1], dtype=..., name=...) -> Tensor4[A4, A3, A2, A1]: ...
