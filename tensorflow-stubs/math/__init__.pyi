...
@overload
def softplus(features: Tensor2[A1, A2], name=...) -> Tensor2[A1, A2]: ...

@overload
def softplus(features: Tensor3[A1, A2, A3], name=...) -> Tensor3[A1, A2, A3]: ...

@overload
def softplus(features: Tensor4[A1, A2, A3, A4], name=...) -> Tensor4[A1, A2, A3, A4]: ...
...
@overload
def softsign(features: Tensor2[A1, A2], name=...) -> Tensor2[A1, A2]: ...

@overload
def softsign(features: Tensor3[A1, A2, A3], name=...) -> Tensor3[A1, A2, A3]: ...

@overload
def softsign(features: Tensor4[A1, A2, A3, A4], name=...) -> Tensor4[A1, A2, A3, A4]: ...

@overload
def softsign(features, name=...) -> Any: ...
